        ...
        const slide = (
            <div className='slider'>
                <div className='slide-content'>
                    <h1 className='movie-title'>{movies[slideIndex].name}</h1>
                    <p className='movie-des'>{movies[slideIndex].des}</p>
                </div>
                <img src={movies[slideIndex].image} alt='' />
            </div>
        );

        setSliders([...sliders, slide]);
